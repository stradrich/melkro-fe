...
async function createBooking() {
  ...
  console.log('Creating booking, you will receive a payment link');
 ...
 // call create timeslot in pinia
  ...
  console.log('We will be redirected to Payment page, if you wish to confirm your Booking, please click on the Stripe Payment Link');
